...
class AboutUsBigScreen extends StatefulWidget {
  const AboutUsBigScreen({Key? key}) : super(key: key);

  @override
  _AboutUsBigScreenState createState() => _AboutUsBigScreenState();
}

class _AboutUsBigScreenState extends State<AboutUsBigScreen> {
