...
class AboutMiddle extends StatefulWidget {
  const AboutMiddle({Key? key}) : super(key: key);

  @override
  _AboutMiddleState createState() => _AboutMiddleState();
}

class _AboutMiddleState extends State<AboutMiddle> {
