...
import '../../widgets/medium_screen_footer.dart';
import '../../widgets/functions.dart';

class WhatWeDoMiddleScreen extends StatefulWidget {
  const WhatWeDoMiddleScreen({Key? key}) : super(key: key);

  @override
  _WhatWeDoMiddleScreenState createState() => _WhatWeDoMiddleScreenState();
}



class _WhatWeDoMiddleScreenState extends State<WhatWeDoMiddleScreen> {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(
              // height: screenSize.height * 0.30,
              width: screenSize.width * 0.47, height: 350,
              child: Card(
                elevation: 7,
                color: Colors.cyan[50],
                child: Column(
